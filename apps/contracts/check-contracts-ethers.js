...
async function main() {
  console.log("🔍 Checking deployed contract addresses on Celo Sepolia...\n");
  ...
  // Also check the addresses from frontend configuration
  console.log("Checking addresses from frontend configuration...\n");
  ...
  for (const [name, address] of Object.entries(frontendAddresses)) {
    console.log(`Checking ${name} at ${address}...`);
