...
// Using proper Hardhat environment
...
async function main() {
  ...
  console.log(`Players: ${players.slice(0, 10).map(p => p.address).slice(0, 10).join(', ')}\n`);
  ...
  const crosswordId = hre.ethers.id("test_crossword_2025");
  ...
  console.log(`💰 Crossword details - Token: ${token}, Prize Pool: ${hre.ethers.formatEther(totalPrizePool)} CELO`);
