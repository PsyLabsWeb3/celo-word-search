...
async function main() {
  console.log("🧪 Testing public crossword creation on Celo Sepolia...\n");
  ...
  const crosswordId = "0x" + "1".repeat(64); // Sample crossword ID
  ...
  console.log("\n🎉 Testing completed!");
  console.log("The crossword creation and fetching functionality is working correctly.");
}
