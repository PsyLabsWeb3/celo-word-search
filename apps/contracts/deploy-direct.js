// Direct deployment script for Celo Sepolia
// This script uses the Hardhat Runtime Environment directly

// We need to import Hardhat in a way that works with the current environment
const hre = require("hardhat");

async function deployContracts() {
  console.log("🚀 Deploying complete modular crossword contracts to Celo Sepolia...");

  // Get the ethers object from the Hardhat Runtime Environment
