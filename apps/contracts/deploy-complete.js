...
// Complete deployment script for all crossword contracts to Sepolia with full configuration
const { ethers, run } = require("hardhat");

async function main() {
  console.log("🚀 Deploying complete modular crossword contracts to Sepolia with full configuration...");
  ...
  console.log("\n🎉 All contracts deployed, configured, and verified successfully on Sepolia!");
  console.log("\n📋 Deployment Summary:");
  console.log(`CrosswordCore:           ${await crosswordCore.getAddress()}`);
  console.log(`CrosswordPrizes:         ${await crosswordPrizes.getAddress()}`);
  console.log(`UserProfiles:            ${await userProfiles.getAddress()}`);
